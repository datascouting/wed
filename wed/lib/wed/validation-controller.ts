...
import {AttributeNameError, DefaultNameResolver, ValidationError} from "salve";
import {ErrorData, ResetData, WorkingState, WorkingStateData} from "salve-dom";
...
export class ValidationController {
  ...
  constructor(private readonly editor: Editor,
              ...
              private readonly errorList: HTMLElement | Element,
